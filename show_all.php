...
try {
    ...
    if (isset($_POST['insertar3'])) {
        ...
        $model2 = new Consultas();
        $model2 -> id_ = htmlspecialchars($_POST["id_"]);
        $model2 -> n_entrada = htmlspecialchars($_POST["n_entrada"]);
        $model2 -> modificar_ticket();
    }elseif(isset($_POST["eliminar"])){
        $model2 = new Consultas();
        $model2 -> id_ = htmlspecialchars($_POST["id_"]);
        $mensaje_ce = $model2 -> mensaje_confirm;
        $model2 -> eliminar_ticket();
    }
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td></td>
                                ...
                                <td><input type="text" class="form-control" style="text-align:center" name="n_entrada" id="n_entrada" value="<?php echo $resultado["n_entrada"]?>" required></td>
                                ...
                                <!-- <td>
                                    ...
                                    <input type="submit" value="delete" class="material-icons">
                                </td> -->
